...
W=pickle.load(open("sc_W_001600_r000000000262074_state_FIBONACCI_MIXED_4.pkl","rb"))
Ht=pickle.load(open("sc_Ht_001600_r000000000262074_state_FIBONACCI_MIXED_4.pkl","rb"))
...
plt.plot(Ht,label='a=20')

#plt.show()
fileout="roughness_linear.png"
